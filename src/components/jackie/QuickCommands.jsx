...
const COMMANDS = [
  ...
  { cmd: 'ship this as a vibe-coded MVP with the fastest credible stack', icon: Zap, label: 'Vibe Build' },
  { cmd: 'visualize the architecture, data flow, and user journey for this idea', icon: Layers, label: 'Visualize' },
  { cmd: 'recommend the best tooling, plugins, and developer workflow for this build', icon: Sparkles, label: 'Tooling' },
  { cmd: 'design the cloud, runtime, storage, and scaling plan for this build', icon: Smartphone, label: 'Cloud Plan' },
