  ...
  if (status === 'error') return (
    <div className="flex flex-col min-h-screen bg-background pb-20">
      <div className="flex-1 flex flex-col items-center justify-center gap-3 px-6 text-center">
        ...
        <p className="text-xs text-muted-foreground/60">Could not reach data source. Check your connection.</p>
      </div>
    </div>
  );
        ...
        <div className="bg-card border-b border-border px-4 py-3">
          ...
          <div className="h-40 mt-3 flex items-center justify-center bg-secondary/40 rounded-xl border border-border">
            <div className="text-center">
              ...
              <p className="text-[10px] text-muted-foreground/60 mt-0.5">Current price shown above is live</p>
            </div>
          </div>
        </div>
      )}
