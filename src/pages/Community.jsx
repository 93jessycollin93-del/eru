...
import { Heart, MessageCircle, Send, Users, Loader2, AlertCircle } from 'lucide-react';
...
export default function Community() {
  ...
  const handlePost = async () => {
    ...
    try {
      ...
      setPosts((prev) => [{ ...created, created_by: me?.email, created_date: new Date().toISOString() }, ...prev]);
      setBody('');
    } catch (err) {
